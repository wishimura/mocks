...
const ICONS = {
  ...
  sparkle: '<svg viewBox="0 0 24 24"><path d="M12 3l2 5 5 2-5 2-2 5-2-5-5-2 5-2 2-5zM19 14l1 3 3 1-3 1-1 3-1-3-3-1 3-1 1-3zM5 2l.7 1.5L7 4l-1.3.5L5 6l-.7-1.5L3 4l1.3-.5L5 2z"/></svg>',
  ...
  line: '<svg viewBox="0 0 24 24" fill="currentColor" stroke="none"><path d="M12 3c5.5 0 10 3.6 10 8 0 1.5-.5 2.9-1.5 4.2-2.1 2.7-6.7 5.9-7.8 6.3-1 .4-.9-.3-.8-.6l.2-1c.1-.5-.1-.5-.4-.5-4.1-.5-7.7-3.4-7.7-8.4C4 6.6 6.5 3 12 3zM9 14.5h2c.3 0 .5-.2.5-.5s-.2-.5-.5-.5H9.5v-3.5c0-.3-.2-.5-.5-.5s-.5.2-.5.5v4c0 .3.2.5.5.5zm4.5 0c.3 0 .5-.2.5-.5v-4c0-.3-.2-.5-.5-.5s-.5.2-.5.5v4c0 .3.2.5.5.5zm2-.5v-2.5l1.9 2.8c.1.1.3.2.4.2.3 0 .5-.2.5-.5v-4c0-.3-.2-.5-.5-.5s-.5.2-.5.5v2.5l-1.9-2.8c-.1-.1-.3-.2-.4-.2-.3 0-.5.2-.5.5v4c0 .3.2.5.5.5s.5-.2.5-.5z"/></svg>',
  chat: '<svg viewBox="0 0 24 24"><path d="M21 12a8 8 0 0 1-11.6 7.1L3 21l1.9-6.4A8 8 0 1 1 21 12z"/></svg>',
  coin: '<svg viewBox="0 0 24 24"><circle cx="12" cy="12" r="9"/><path d="M12 7v10M9 10h4.5a1.5 1.5 0 0 1 0 3H9M9 13h4.5a1.5 1.5 0 0 1 0 3H9"/></svg>',
...
(function () {
  ...
  // Single-select option groups (store / course / day / time)
